...
<div style="margin: 20px 500px">
    <form action="/contract?action=create" method="post">
        <pre>Start Date:        <input type="date" name="startDate"> </pre>
        <pre>End Date:          <input type="date" name="endDate"> </pre>
        <pre>Deposit:           <input type="text" name="deposit"> </pre>
        <pre>Employee Id:       <input type="text" name="employeeId"> </pre>
        <pre>Customer Id:       <input type="text" name="customerId"> </pre>
        <pre>Facility Id:       <input type="text" name="facilityId"> </pre>
