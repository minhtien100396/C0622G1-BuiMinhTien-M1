                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a class="navbar-brand" href="../../index.jsp" style="color: pink"><strong
                                            style="font-size: 20px">Contract <span
                    ...
                    <table class="table table-striped table-hover" id="tableStudent" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <c:forEach var="contract" items="${contractList}" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <fmt:formatNumber value="${contract.deposit}" type="number" maxFractionDigits="2" />
                                </td>
                                ...
                                <td style="text-align: center">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="color: #000">
                                                    Do you want to change an service <strong class="text-danger">${contract.id}</strong> ?
                                                </div>
                                    ...
                                    <div class="modal fade" id="exampleModal${contract.id}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: #000">Remove Contract From List</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="color: #000">
                                                    <span style="font-size: 16px">Do you want to delete an contract <strong class="text-danger">${contract.id}</strong> ?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close
                                                    </button>
