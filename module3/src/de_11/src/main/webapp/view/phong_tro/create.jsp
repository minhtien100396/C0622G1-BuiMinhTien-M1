    ...
    <form action="/phongtro?action=create" method="post">
        <table border="1" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="tenNguoiThueTro" id="tenNguoiThueTro" size="45"
                           value='${phongTro.tenNguoiThueTro}'/>
            ...
            <tr>
                ...
                <td>
                    <input type="date" name="ngayBatDauThueTro" id="ngayBatDauThueTro" size="15"
                           value='${phongTro.ngayBatDauThueTro}'/>
                ...
                <td>
                    <select id="maThanhToan" name="maThanhToan">
                        ...
                        <c:forEach var="hinhThucThanhToanMap" items="${hinhThucThanhToanMap}">
                            <option value="${hinhThucThanhToanMap.key}" ${hinhThucThanhToanMap.key==phongTro.maThanhToan?"selected":""} >${hinhThucThanhToanMap.value}</option>
                        </c:forEach>
                    </select>
