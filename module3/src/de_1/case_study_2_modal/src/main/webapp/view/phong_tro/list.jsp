                                        ...
                                        <div class="col-lg-12">
                                            <c:if test="${show != null}">
                                                <a href="#add" class="btn btn-success d-flex align-items-center" id="auto-click" data-toggle="modal" style="color: pink;border-color: pink; border-width: 3px; line-height: 45px; background: black; max-width:240px; "><i
                                                        class="material-icons">&#xE147;</i> <span>Thêm Mới Phòng Trọ</span></a>
                                            </c:if>
                                            <c:if test="${show == null}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/phongtro?action=create" method="post">
                <div class="modal-header">
                    <h4 class="modal-title">Thêm Mới Phòng Trọ</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tên Người Thuê Trọ: <input type="text" class="form-control" name="name"
                                                          value="${phongTro.name}"> </label>
                    ...
                    <div class="form-group">
                        ...
                        <label>Số Điện Thoại: <input type="text" class="form-control" name="phoneNumber"
                                                     value="${phongTro.phoneNumber}"> </label>
                        <label style="color:red;"> ${map.get('phoneNumber')}</label>
                    </div>
                    <div class="form-group">
                        <%--                        <label>Description</label>--%>
                        <%--                        <textarea class="form-control" required name="description"></textarea>--%>
                        <label>Ngày Bắt Đầu Thuê Trọ: <input type="date" class="form-control" name="dateBegin"
                                                             value="${phongTro.dateBegin}"> </label>
                        <label style="color:red;"> ${map.get('dateBegin')}</label>
                    </div>
                    <div class="form-group">
                        <%--                        <label>Manufacture</label>--%>
                        <%--                        <input type="text" class="form-control" required name="manufacture">--%>
                        <label>Ghi Chú: <input type="text" class="form-control" name="note"
                                               value="${phongTro.note}"></label>
                        <label style="color:red;"> ${map.get('note')}</label>
                    </div>
                    <div class="form-group">
                        <label>Hình Thức Thanh Toán: <select id="idThanhToan" class="form-control" name="idThanhToan">
