                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-black">
                                <li><a class="dropdown-item" href="/phongtro">Quản Lý Phòng Trọ</a></li>
                                <li><hr class="dropdown-divider bg-light"></li>
                                <li><a class="dropdown-item" href="/phongtro?action=create">Thêm Mới Phòng Trọ</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu bg-black">
                                <li><a class="dropdown-item" href="/product">Product Management</a></li>
                                <li><hr class="dropdown-divider bg-light"></li>
                                <li><a class="dropdown-item" href="/product?action=create">Create New Product</a></li>
                            </ul>
                        </li>
