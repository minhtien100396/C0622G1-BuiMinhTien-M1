    ...
    <div class="container-fluid">
        <nav class="navbar navbar-light bg-black">
            <div class="container-fluid" style="height: 120px; line-height: 120px;margin-top: -10px">
                ...
                <form action="/product" style="height: 30px; line-height: 30px">
                    <input type="hidden" name="action" value="search">
                    <input type="text" name="searchName" placeholder="Tên Sản Phẩm">
                    <input type="text" name="searchPrice" placeholder="Giá Sản Phẩm">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a class="navbar-brand" href="../../index.jsp" style="color: pink"><strong
                                            ...
                                            style="font-style: italic;border-radius: 10px;background-color: deeppink; color: white; font-size: 30px">Sản Phẩm</span></strong></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <c:if test="${show != null}">
                                                <a href="#add" class="btn btn-success d-flex align-items-center" id="auto-click" data-toggle="modal" style="color: pink;border-color: pink; border-width: 3px; line-height: 45px; background: black; max-width:240px; "><i
                                                        class="material-icons">&#xE147;</i> <span>Thêm Mới Sản Phẩm</span></a>
                                            </c:if>
                                            <c:if test="${show == null}">
                                                <a href="#add" class="btn btn-success d-flex align-items-center" data-toggle="modal" style="max-width:240px;color: pink;border-color: pink; border-width: 3px; line-height: 45px; background: black"><i
                                                        class="material-icons">&#xE147;</i> <span>Thêm Mới Sản Phẩm</span></a>
                                            </c:if>
                                        </div>
                                    </div>
                ...
                <div class="table-wrapper">
                    <table class="table table-striped table-hover" id="tableStudent"
                        ...
                        <c:forEach var="product" items="${productList}" varStatus="loop">
                            <tr>
                                <td>${loop.count}</td>
                                <td style="word-wrap: normal;">${product.name}</td>
                                <td>${product.price}</td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="color: #000">
                                                    Bạn Có Muốn Thay Đổi Thông Tin Phòng Trọ Của <strong
                                                        class="text-danger">${product.name}</strong> Không ?
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="color: #000">
                                                    <span style="font-size: 16px">Bạn có muốn xóa thông tin phòng trọ của <strong
                                                            class="text-danger">${product.name}</strong> không ?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Đóng
            ...
            <form action="/product?action=create" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Name: <input type="text" class="form-control" name="name"
                                                          value="${product.name}"> </label>
                        <p style="color:red;"> ${map.get('name')}</p>
                    </div>
                    <div class="form-group">
                        <label>Price: <input type="text" class="form-control" name="price"
                                                     value="${product.price}"> </label>
                        <label style="color:red;"> ${map.get('price')}</label>
                    </div>
                    <div class="form-group">
                        <label>Quantity: <input type="text" class="form-control" name="quantity"
                                                             value="${product.quantity}"> </label>
                        <label style="color:red;"> ${map.get('quantity')}</label>
                    </div>
                    <div class="form-group">
                        <label>Color: <input type="text" class="form-control" name="color"
                                               value="${product.color}"></label>
                        <label style="color:red;"> ${map.get('color')}</label>
                    </div>
                    <div class="form-group">
                        <label>Category: <input type="text" class="form-control" name="category"
                                             value="${product.category}"></label>
                        <label style="color:red;"> ${map.get('category')}</label>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    let eBtnAdd = document.getElementById('auto-click');
    eBtnAdd.click();
</script>
</body>
</html>