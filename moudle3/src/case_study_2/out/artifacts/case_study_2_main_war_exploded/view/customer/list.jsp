                    ...
                    <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a class="navbar-brand" href="../../index.jsp" style="color: pink"><strong
                                            style="font-size: 20px">Customer <span
                                            style="font-style: italic;border-radius: 10px;background-color: deeppink; color: white;font-size: 30px">Management</span></strong></a>
                        ...
                        <div class="col-lg-4">
                            <div class="row" style="margin-right: 10px">
                                <div class="col-lg-12">
                                    <form action="/customer" class="d-flex" role="search">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="/customer?action=create"> <input class="btn btn-outline-success" type="submit" value="Add New Customer"
                    ...
                    <table class="table table-striped table-hover" id="tableStudent"
                        ...
                        <c:forEach var="customer" items="${customerList}">
                            <tr>
                                ...
                                <c:if test="${!customerTypeMap.containsKey(customer.customerTypeId)}">
                                    <td>
                                        No Customer Type
                                    </td>
                                </c:if>
                                ...
                                <td style="text-align: center">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="color: #000">
                                                    Bạn có muốn thay đổi thông tin <strong class="text-danger">${customer.name}</strong> không ?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close
                                                    </button>
                                                    <a href="/customer?action=edit&id=${customer.id}" class="btn btn-secondary">Thay Đổi</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="exampleModal${customer.id}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: #000">Remove Customer From List</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="color: #000">
                                                    <span style="font-size: 16px">Do you want to delete an customer <strong class="text-danger">${customer.name}</strong> ?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close
                                                    </button>
                                                    <a href="/customer?action=delete&id=${customer.id}" class="btn btn-secondary" ><span>Delete</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
