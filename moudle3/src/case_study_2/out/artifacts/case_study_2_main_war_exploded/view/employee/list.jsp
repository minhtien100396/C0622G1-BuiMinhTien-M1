                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a class="navbar-brand" href="../../index.jsp" style="color: pink"><strong
                                            style="font-size: 20px">Employee <span
                ...
                <div class="table-wrapper">
                    <table class="table table-striped table-hover" id="tableStudent"
                        ...
                        <c:forEach var="employee" items="${employeeList}">
                            <tr>
                                <td>${employee.id}</td>
                                <td style="word-wrap: normal;">${employee.name}</td>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: #000">
                                                        Remove Employee From List</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="color: #000">
                                                    <span style="font-size: 16px">Do you want to delete an employee <strong
                                                            class="text-danger">${employee.name}</strong> ?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/employee?action=delete&id=${employee.id}"
                                                       class="btn btn-secondary"><span>Delete</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
