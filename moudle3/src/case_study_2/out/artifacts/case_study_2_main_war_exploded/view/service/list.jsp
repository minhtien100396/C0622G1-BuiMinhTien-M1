                    ...
                    <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a class="navbar-brand" href="../../index.jsp" style="color: pink"><strong
                                            style="font-size: 20px">Service <span
                        ...
                        <div class="col-lg-4">
                            <div class="row" style="margin-right: 10px">
                                <div class="col-lg-12">
                                    <form action="/service" method="get" class="d-flex" role="search">
                    ...
                    <table class="table table-striped table-hover" id="tableStudent"
                        ...
                        <c:forEach var="service" items="${serviceList}">
                            <tr>
                                ...
                                <c:if test="${!rentTypeMap.containsKey(service.rentTypeId)}">
                                    <td>
                                        No Rent Type
                                    </td>
                                </c:if>
                                <td>${rentTypeMap.get(service.rentTypeId)}</td>
                                <c:if test="${!facilityTypeMap.containsKey(service.facilityTypeId)}">
                                    <td>
                                        No Facility Type
                                    </td>
                                </c:if>
                                <td>${facilityTypeMap.get(service.facilityTypeId)}</td>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <div class="modal fade" id="exampleModal${service.id}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: #000">Remove Service From List</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="color: #000">
                                                    <span style="font-size: 16px">Do you want to delete an service <strong class="text-danger">${service.name}</strong> ?</span>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close
                                                    </button>
