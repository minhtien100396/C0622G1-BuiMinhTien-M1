            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach var="product" items="${products}" varStatus="loop">
                    <tr>
                        ...
                        <td>
                            <a href="#editEmployeeModal" class="edit" data-toggle="modal" data-id="${product.id}"
                               data-name="${product.name}" data-price="${product.price}"
                               data-description="${product.description}" data-manufacture="${product.manufacture}"><i
                                    class="material-icons"
                                    data-toggle="tooltip"
                                    title="Edit">&#xE254;</i></a>
                            <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-id="${product.id}"><i
                                    class="material-icons"
                                    data-toggle="tooltip"
                                    title="Delete">&#xE872;</i></a>
                        </td>
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="?actionProduct=add" method="post">
...
<div id="editEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="?actionProduct=edit" method="post">
                <div class="modal-header">
...
<div id="deleteAll" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="?actionProduct=deleteAll" method="post">
                <div class="modal-header">
